<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item <?php echo ($page == "userindex") ? "active": ""; ?>">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item <?php echo ($page == "menus") ? "active": ""; ?>">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item <?php echo ($page == "signages") ? "active": ""; ?>">
        <a class="nav-link" href="<?php echo base_url() ?>signages">
