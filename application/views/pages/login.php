...
<head>
  ...
  <title>Interactive Menu Master Login</title>
                  ...
                  <?php echo form_open('authentication/user_login_process'); ?>
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" id="customCheck" name="rememberme" value="yes">
                    ...
                    <?php echo form_close(); ?>
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url(); ?>forgotpassword">Forgot Password?</a>
                  </div>
                </div>
              </div>
            </div>
