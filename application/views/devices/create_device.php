<!-- Begin Page Content -->
<div class="container">
<h1  class="h3 mb-4 text-gray-800">Create Device</h1>
...
<div class="card shadow mb-4">
            ...
            <div class="card-body">
    <?php echo form_open("devices/create_device");?>
      ...
      <p>
            Company Name <br />
            <?php echo form_dropdown($company_id["name"], $company_id["data"], NULL, 'class="form-control"');?>
      </p>
      <p>
      ...
      <p><input type="submit" value="Create Device" name="submit" class="btn btn-primary btn-user "/>
        </p>
